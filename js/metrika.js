/* Яндекс.Метрика. Номер счётчика и цели живут в одном файле, а не в копиях
   по страницам. Счётчик 112562315 заведён 14.09.2026 на аккаунте Евгения.
   Если поставить METRIKA_ID = 0, счётчик отключится и ничего не будет слать. */

var METRIKA_ID = 112562315;
